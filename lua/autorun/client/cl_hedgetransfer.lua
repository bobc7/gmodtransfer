...
function hedgeOpenMenu()
    ...
    local Frame = vgui.Create( "DFrame" )
        ...
        Frame.Paint = function(s, w, h) -- 'function Frame:Paint( w, h )' works too
...
-- Get all players and sort through to make buttons
    ...
    for k,v in ipairs(players) do
        ...
        buttons.DoClick = function()
            ...
            if (!v:IsValid()) then print("That is not a valid player!") return end
            ...
            requestTransfer.DoClick = function () chat.AddText("The request feature is a work in progress. Please join the discord for updates!") return false end
...
hook.Add("OnPlayerChat", "hedgeChatOpenTransfer", function(ply, text, teamChat, isDead) -- TODO: Add check for customization to disable commands while dead?
